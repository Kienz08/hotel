...
<head>
  ...
  <title>Hotel Kolektiv || Modern Hotel</title>
        ...
        <div class="content">
          <div class="container">
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/img/Kolektiv.jpg" alt="First slide" height="550" >
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/img/Kollektiv-Hotel.jpg" alt="Second slide" height="550">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/img/fasilitas_kafee.jpg" alt="Third slide" height="550">
                      </div>
                    </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                      ...
                      <button type="submit" class="btn btn-primary" href="cetak.php">Konfirmasi Pesanan</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
            ...
            <div class="card">
              <div class="col-md-12">
                <div class="card-body">
                  <h2 class="text-center"><strong>Tentang Kami</h2><br></strong>
                  <p class="text-center">Selamat Datang di Hotel Kami,dan selamat menikmati fasilitas yang kami sediakan dan enjoy your holiday!!</p>
                </div>
              </div>
            </div>          
          </div><!-- /.container-fluid -->
